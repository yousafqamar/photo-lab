class PhotoLab {
    constructor() {
        ...
        this.centeringGuidelines = null; // For centering guidelines
    }
    ...
    createNewCanvas() {
        ...
        this.initializeCenteringGuidelines(); // Add guidelines object to canvas
//        this.initAligningGuidelines(); // Add object-to-object guidelines
        this.afterCanvasInit();
    }
    
//    initializeCenteringGuidelines() {
...
//
//        const onAfterRender = () => {
//            console.log( 'isInVerticalCenter: ', isInVerticalCenter );
//            if (isInVerticalCenter) showVerticalCenterLine();
//            if (isInHorizontalCenter) showHorizontalCenterLine();
//        };
//
//        const onMouseUp = () => {
